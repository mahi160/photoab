    ...
    <>
      ...
      <div className="flex flex-col items-center w-full max-w-6xl animate-fade-in px-4">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <span
                    className={`${idx === 0 ? "bg-blue-600 hover:bg-blue-500" : "bg-purple-600 hover:bg-purple-500"} text-white px-8 py-3 rounded-full font-bold text-xl shadow-lg transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300`}
                  >
              ...
              <button
                ...
                className="absolute top-4 right-4 p-2 bg-white/80 hover:bg-white rounded-full text-gray-800 shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20 backdrop-blur-sm"
        ...
        <p className="mt-12 text-gray-400 text-sm uppercase tracking-widest font-semibold">
          Click your favorite to eliminate the other
        </p>
      </div>
    </>
  );
